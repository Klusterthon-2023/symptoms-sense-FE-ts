  ...
  return (
    ...
    >
      ...
      <Box display="flex" flexWrap="wrap" gap="0.8rem">
        ...
        <Box display="flex" justifyContent="center" alignItems="center" borderRadius="0.375rem" bgColor="#F1F1F2" width="2.375rem" height="2.375rem">
          <Image src={mode} alt="mode" />
        </Box>

        <Box ml="0.62rem" display="flex" justifyContent="center" alignItems="center" borderRadius="0.375rem" bgColor="#EEF6FF" width="2.375rem" height="2.375rem">
